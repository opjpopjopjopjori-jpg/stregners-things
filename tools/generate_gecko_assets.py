#!/usr/bin/env python3
"""Generate 3D GeckoLib geometry for Rift Companions using 512px HD player skins.

This generator creates high-resolution 3D character models mapped to 512x512
upscaled player skins (8x standard 64x64 Minecraft player skin UV coordinates),
enriched with realistic 3D hair volume/strands and realistic 3D eyes/eyebrows.
...
# ATLAS defines standard 512x512 regions (8x standard 64x64 Minecraft player skin UVs)
# plus dedicated 3D extension UV sheets for realistic 3D hair and 3D eyes.
ATLAS: dict[str, tuple[int, int, int, int]] = {
    "head_front": (64, 64, 64, 64),
    "head_back": (192, 64, 64, 64),
    "head_left": (128, 64, 64, 64),
    "head_right": (0, 64, 64, 64),
    "head_top": (64, 0, 64, 64),
    "head_bottom": (128, 0, 64, 64),
    "skin_tile": (64, 64, 64, 64),
    "hair_tile": (320, 0, 64, 64),
    "eye_tile": (256, 256, 32, 16),
    "metal_tile": (32, 160, 16, 16),
    "torso_front": (160, 160, 64, 96),
    "torso_back": (256, 160, 64, 96),
    "torso_left": (224, 160, 32, 96),
    "torso_right": (128, 160, 32, 96),
    "torso_top": (160, 128, 64, 32),
    "torso_bottom": (224, 128, 64, 32),
    "jacket_tile": (160, 288, 64, 96),
    "shirt_tile": (160, 160, 64, 96),
    "pants_tile": (32, 160, 32, 96),
    "leather_tile": (32, 160, 32, 32),
    "arm_left_front": (288, 416, 32, 96),
    "arm_left_back": (352, 416, 32, 96),
    "arm_right_front": (352, 160, 32, 96),
    "arm_right_back": (416, 160, 32, 96),
    "sleeve_tile": (352, 288, 32, 96),
    "cuff_tile": (352, 320, 32, 32),
    "field_tile": (160, 288, 64, 96),
    "accent_tile": (288, 256, 16, 16),
    "thread_tile": (304, 256, 16, 16),
    "boot_tile": (32, 232, 32, 24),
    "pack_tile": (160, 288, 32, 48),
    "hand_left": (288, 464, 32, 32),
    "hand_right": (352, 208, 32, 32),
    "leg_left_front": (160, 416, 32, 96),
    "leg_left_back": (224, 416, 32, 96),
    "leg_right_front": (32, 160, 32, 96),
    "leg_right_back": (96, 160, 32, 96),
    "knee_tile": (32, 200, 32, 32),
    "sole_tile": (32, 232, 32, 16),
    "cloth_tile": (160, 160, 64, 96),
    "utility_tile": (160, 288, 64, 96),
    "signal_tile": (32, 160, 16, 16),
    "weather_tile": (160, 288, 64, 96),
    "spare_tile": (32, 160, 32, 32),
}
...
# Dedicated 3D Hair and 3D Eye/Eyebrow UV coordinates in the 512x512 extension sheet
HAIR_3D_SURFACE = box_faces(0, 256, 8, 8, 8)
EYE_WHITE_SURFACE = box_faces(256, 256, 2, 1, 1)
IRIS_SURFACE = box_faces(272, 256, 1, 1, 1)
GLINT_SURFACE = box_faces(288, 256, 1, 1, 1)
LID_SURFACE = box_faces(256, 272, 2, 1, 1)
BROW_SURFACE = box_faces(272, 272, 3, 1, 1)
MOUTH_SURFACE = box_faces(288, 272, 2, 1, 1)
...
def sleeve_layers(spec: Build) -> list[dict[str, Any]]:
    ...
    return [
        bone(f"{spec.role}_left_upper_sleeve", "left_arm_upper", [arm_x, 19.2, 0], [
            cube([arm_x - half_arm, 16.0, -arm_depth / 2], [4, 6, 4], box_faces(384, 384, 4, 12, 4), inflate=0.25),
        ]),
        bone(f"{spec.role}_right_upper_sleeve", "right_arm_upper", [-arm_x, 19.2, 0], [
            cube([-arm_x - half_arm, 16.0, -arm_depth / 2], [4, 6, 4], box_faces(320, 256, 4, 12, 4), inflate=0.25),
        ]),
        bone(f"{spec.role}_left_lower_sleeve", "left_arm_lower", [arm_x, 13.8, 0], [
            cube([arm_x - half_arm, 12.0, -arm_depth / 2], [4, 4, 4], box_faces(384, 384, 4, 12, 4), inflate=0.25),
        ]),
        bone(f"{spec.role}_right_lower_sleeve", "right_arm_lower", [-arm_x, 13.8, 0], [
            cube([-arm_x - half_arm, 12.0, -arm_depth / 2], [4, 4, 4], box_faces(320, 256, 4, 12, 4), inflate=0.25),
        ]),
        bone(f"{spec.role}_left_cuff", "left_arm_lower", [arm_x, 11.8, 0], [
            cube([arm_x - half_arm, 10.0, -arm_depth / 2], [4, 2, 4], box_faces(384, 384, 4, 12, 4), inflate=0.28),
        ]),
        bone(f"{spec.role}_right_cuff", "right_arm_lower", [-arm_x, 11.8, 0], [
            cube([-arm_x - half_arm, 10.0, -arm_depth / 2], [4, 2, 4], box_faces(320, 256, 4, 12, 4), inflate=0.28),
        ]),
    ]


def anatomy(spec: Build) -> list[dict[str, Any]]:
    """Standard 3D humanoid body mapped to 8x Minecraft player skin UVs with face details."""
    half_head = spec.head_width / 2
    return [
        bone("root", None, [0, 0, 0]),
        bone("body", "root", [0, 12, 0]),
        bone("chest", "body", [0, 20, 0], [
            cube([-4, 12, -2], [8, 12, 4], box_faces(128, 128, 8, 12, 4)),
            cube([-4, 12, -2], [8, 12, 4], box_faces(128, 256, 8, 12, 4), inflate=0.25),
        ]),
        bone("torso_ribcage", "chest", [0, 19.0, 0], [
            cube([-4, 15, -2], [8, 6, 4], box_faces(128, 128, 8, 12, 4), inflate=0.01),
        ]),
        bone("torso_waist", "chest", [0, 14.0, 0], [
            cube([-3.8, 12, -1.8], [7.6, 3, 3.6], box_faces(128, 128, 8, 12, 4), inflate=0.01),
        ]),
        ...
        bone("face_core", "head", [0, 28.0, 0], [
            ...
            cube([-half_head, 24, -half_head], [spec.head_width, spec.head_width, spec.head_width], box_faces(256, 0, 8, 8, 8), inflate=0.5),
        ]),
        bone("face_forehead", "head", [0, 31.0, 0], [
            cube([-3.6, 30.2, -4.08], [7.2, 1.4, 0.4], box_faces(64, 64, 8, 8, 8), inflate=0.01),
        ]),
        bone("face_left_cheek", "head", [-half_head, 28.0, 0], [
            cube([-4.1, 25.5, -3.8], [0.6, 3.5, 6.8], box_faces(64, 64, 8, 8, 8), inflate=0.01),
        ]),
        bone("face_right_cheek", "head", [half_head, 28.0, 0], [
            cube([3.5, 25.5, -3.8], [0.6, 3.5, 6.8], box_faces(64, 64, 8, 8, 8), inflate=0.01),
        ]),
        bone("face_left_ear", "head", [-4.4, 27.6, 0], [
            cube([-4.6, 26.2, -0.6], [0.6, 2.4, 1.4], box_faces(64, 64, 8, 8, 8), inflate=0.02),
        ]),
        bone("face_right_ear", "head", [4.4, 27.6, 0], [
            cube([4.0, 26.2, -0.6], [0.6, 2.4, 1.4], box_faces(64, 64, 8, 8, 8), inflate=0.02),
        ]),
        bone("jaw", "head", [0, 24, -4]),
        bone("face_chin", "jaw", [0, 25.3, 0], [
            cube([-3.2, 24.1, -4.1], [6.4, 1.6, 1.6], box_faces(64, 64, 8, 8, 8), inflate=0.01),
        ]),
        bone("nose_bridge", "head", [0, 27.9, -half_head], [
            cube([-0.5, 26.8, -4.3], [1.0, 2.0, 0.6], box_faces(64, 64, 8, 8, 8), inflate=0.01),
        ]),
        bone("nose_tip", "head", [0, 27.0, -half_head], [
            cube([-0.8, 26.4, -4.5], [1.6, 0.8, 0.8], box_faces(64, 64, 8, 8, 8), inflate=0.01),
        ]),
        ...
        # Left arm (segmented upper/lower/hand mapped to standard left arm coordinates)
        bone("left_arm", "chest", [5.0, 22, 0]),
        bone("left_arm_upper", "left_arm", [5.0, 22, 0], [
            cube([4.0, 16.0, -2.0], [4, 6, 4], box_faces(256, 384, 4, 12, 4)),
        ]),
        bone("left_arm_lower", "left_arm_upper", [5.0, 16.0, 0], [
            cube([4.0, 12.0, -2.0], [4, 4, 4], box_faces(256, 384, 4, 12, 4)),
        ]),
        bone("left_hand", "left_arm_lower", [5.0, 12.0, 0], [
            cube([4.0, 10.0, -2.0], [4, 2, 4], box_faces(256, 384, 4, 12, 4)),
        ]),
        # Right arm (segmented upper/lower/hand mapped to standard right arm coordinates)
        bone("right_arm", "chest", [-5.0, 22, 0]),
        bone("right_arm_upper", "right_arm", [-5.0, 22, 0], [
            cube([-8.0, 16.0, -2.0], [4, 6, 4], box_faces(320, 128, 4, 12, 4)),
        ]),
        bone("right_arm_lower", "right_arm_upper", [-5.0, 16.0, 0], [
            cube([-8.0, 12.0, -2.0], [4, 4, 4], box_faces(320, 128, 4, 12, 4)),
        ]),
        bone("right_hand", "right_arm_lower", [-5.0, 12.0, 0], [
            cube([-8.0, 10.0, -2.0], [4, 2, 4], box_faces(320, 128, 4, 12, 4)),
        ]),
        # Left leg (segmented upper/lower/foot mapped to standard left leg coordinates)
        bone("left_leg", "root", [2.0, 12, 0]),
        bone("left_leg_upper", "left_leg", [2.0, 12, 0], [
            cube([0.0, 6.0, -2.0], [4, 6, 4], box_faces(128, 384, 4, 12, 4)),
            cube([0.0, 6.0, -2.0], [4, 6, 4], box_faces(0, 384, 4, 12, 4), inflate=0.25),
        ]),
        bone("left_leg_lower", "left_leg_upper", [2.0, 6.0, 0], [
            cube([0.0, 2.0, -2.0], [4, 4, 4], box_faces(128, 384, 4, 12, 4)),
            cube([0.0, 2.0, -2.0], [4, 4, 4], box_faces(0, 384, 4, 12, 4), inflate=0.25),
        ]),
        bone("left_foot", "left_leg_lower", [2.0, 2.0, 0], [
            cube([0.0, 0.0, -2.0], [4, 2, 4], box_faces(128, 384, 4, 12, 4)),
        ]),
        # Right leg (segmented upper/lower/foot mapped to standard right leg coordinates)
        bone("right_leg", "root", [-2.0, 12, 0]),
        bone("right_leg_upper", "right_leg", [-2.0, 12, 0], [
            cube([-4.0, 6.0, -2.0], [4, 6, 4], box_faces(0, 128, 4, 12, 4)),
            cube([-4.0, 6.0, -2.0], [4, 6, 4], box_faces(0, 256, 4, 12, 4), inflate=0.25),
        ]),
        bone("right_leg_lower", "right_leg_upper", [-2.0, 6.0, 0], [
            cube([-4.0, 2.0, -2.0], [4, 4, 4], box_faces(0, 128, 4, 12, 4)),
            cube([-4.0, 2.0, -2.0], [4, 4, 4], box_faces(0, 256, 4, 12, 4), inflate=0.25),
        ]),
        bone("right_foot", "right_leg_lower", [-2.0, 2.0, 0], [
            cube([-4.0, 0.0, -2.0], [4, 2, 4], box_faces(0, 128, 4, 12, 4)),
        ]),
...
def seer_visuals(spec: Build) -> list[dict[str, Any]]:
    return [
        ...
        bone("seer_flannel_left", "accessory_2", [2.1, 18.0, -2.0], [cube([0.1, 13.5, -2.1], [3.0, 8.5, 0.4], box_faces(128, 256, 3, 8, 1), inflate=0.01)]),
        bone("seer_flannel_right", "accessory_2", [-2.1, 18.0, -2.0], [cube([-3.1, 13.5, -2.1], [3.0, 8.5, 0.4], box_faces(128, 256, 3, 8, 1), inflate=0.01)]),
        bone("seer_tshirt_front", "accessory_2", [0, 18.0, -2.2], [cube([-1.5, 14.0, -2.25], [3.0, 7.5, 0.3], box_faces(128, 128, 3, 7, 1), inflate=0.01)]),
        bone("seer_shirt_tail", "accessory_2", [0, 13.2, 2.0], [cube([-4.0, 11.0, 1.8], [8.0, 2.5, 0.4], box_faces(128, 256, 8, 4, 1), inflate=0.01)]),
        bone("seer_collar_left", "accessory_2", [2.5, 21.5, -2.1], [cube([0.5, 20.0, -2.3], [3.0, 2.5, 0.4], box_faces(128, 256, 4, 3, 1), inflate=0.01)]),
        bone("seer_collar_right", "accessory_2", [-2.5, 21.5, -2.1], [cube([-3.5, 20.0, -2.3], [3.0, 2.5, 0.4], box_faces(128, 256, 4, 3, 1), inflate=0.01)]),
        *sleeve_layers(spec),
    ]
...
def guardian_visuals(spec: Build) -> list[dict[str, Any]]:
    return [
        ...
        # Clothing motion layers
        bone("guardian_workcoat_front", "accessory_2", [0, 18.0, -2.2], [cube([-3.9, 13.0, -2.25], [7.8, 9.5, 0.4], box_faces(128, 256, 8, 9, 1), inflate=0.01)]),
        bone("guardian_workcoat_back", "accessory_2", [0, 18.0, 2.1], [cube([-3.9, 13.0, 1.85], [7.8, 9.5, 0.5], box_faces(128, 256, 8, 9, 1), inflate=0.01)]),
        bone("guardian_shirt_front", "accessory_2", [0, 18.0, -2.3], [cube([-1.4, 14.0, -2.5], [2.8, 8.0, 0.3], box_faces(128, 128, 3, 8, 1), inflate=0.01)]),
        bone("guardian_belt", "accessory_2", [0, 13.5, 0], [cube([-3.8, 12.7, -2.15], [7.6, 1.2, 4.3], box_faces(128, 256, 8, 1, 4), inflate=0.01)]),
        bone("guardian_buckle", "guardian_belt", [0, 13.4, -2.3], [cube([-0.8, 12.9, -2.5], [1.6, 0.9, 0.3], box_faces(128, 256, 2, 1, 1), inflate=0.01)]),
        bone("guardian_watch", "left_arm_lower", [3.9, 12.0, -1.6], [cube([3.5, 11.4, -2.1], [1.3, 1.1, 0.4], box_faces(384, 384, 1, 1, 1), inflate=0.01)]),
        bone("guardian_coat_tail", "accessory_2", [0, 13.0, 2.1], [cube([-4.1, 10.5, 1.9], [8.2, 2.8, 0.5], box_faces(128, 256, 8, 4, 1), inflate=0.01)]),
        bone("guardian_collar_left", "accessory_2", [2.6, 21.5, -2.2], [cube([0.4, 19.8, -2.5], [3.2, 2.8, 0.5], box_faces(128, 256, 4, 3, 1), inflate=0.01)]),
        bone("guardian_collar_right", "accessory_2", [-2.6, 21.5, -2.2], [cube([-3.6, 19.8, -2.5], [3.2, 2.8, 0.5], box_faces(128, 256, 4, 3, 1), inflate=0.01)]),
        *sleeve_layers(spec),
    ]
...
def gifted_visuals(spec: Build) -> list[dict[str, Any]]:
    return [
        ...
        # Clothing motion layers
        bone("gifted_denim_front", "accessory_2", [0, 18.0, -2.1], [cube([-3.3, 13.2, -2.12], [6.6, 9.5, 0.4], box_faces(128, 256, 7, 9, 1), inflate=0.01)]),
        bone("gifted_denim_back", "accessory_2", [0, 18.0, 2.05], [cube([-3.3, 13.2, 1.72], [6.6, 9.5, 0.5], box_faces(128, 256, 7, 9, 1), inflate=0.01)]),
        bone("gifted_tshirt_front", "accessory_2", [0, 17.9, -2.25], [cube([-1.3, 14.0, -2.45], [2.6, 7.8, 0.3], box_faces(128, 128, 3, 8, 1), inflate=0.01)]),
        bone("gifted_zipper", "accessory_2", [0, 17.9, -2.35], [cube([-0.15, 13.4, -2.6], [0.3, 9.1, 0.2], box_faces(128, 256, 1, 9, 1), inflate=0.01)]),
        bone("gifted_front_pocket", "accessory_2", [2.0, 15.9, -2.15], [cube([0.7, 14.2, -2.35], [2.1, 2.3, 0.3], box_faces(128, 256, 2, 2, 1), inflate=0.01)]),
        bone("gifted_watch", "right_arm_lower", [-3.9, 12.0, -1.6], [cube([-4.8, 11.4, -2.1], [1.3, 1.1, 0.4], box_faces(320, 256, 1, 1, 1), inflate=0.01)]),
        bone("gifted_jacket_tail", "accessory_2", [0, 13.0, 2.0], [cube([-4.0, 10.8, 1.8], [8.0, 2.5, 0.4], box_faces(128, 256, 8, 4, 1), inflate=0.01)]),
        bone("gifted_collar_left", "accessory_2", [2.5, 21.5, -2.1], [cube([0.5, 19.8, -2.4], [3.0, 2.6, 0.4], box_faces(128, 256, 4, 3, 1), inflate=0.01)]),
        bone("gifted_collar_right", "accessory_2", [-2.5, 21.5, -2.1], [cube([-3.5, 19.8, -2.4], [3.0, 2.6, 0.4], box_faces(128, 256, 4, 3, 1), inflate=0.01)]),
        *sleeve_layers(spec),
    ]
...
def scout_visuals(spec: Build) -> list[dict[str, Any]]:
    return [
        ...
        # Clothing motion layers
        bone("scout_jacket_front", "accessory_2", [0, 18.0, -2.1], [cube([-3.4, 13.2, -2.15], [6.8, 9.5, 0.4], box_faces(128, 256, 7, 9, 1), inflate=0.01)]),
        bone("scout_jacket_back", "accessory_2", [0, 18.0, 2.05], [cube([-3.4, 13.2, 1.72], [6.8, 9.5, 0.5], box_faces(128, 256, 7, 9, 1), inflate=0.01)]),
        bone("scout_tshirt_front", "accessory_2", [0, 17.9, -2.25], [cube([-1.4, 14.0, -2.48], [2.8, 7.8, 0.3], box_faces(128, 128, 3, 8, 1), inflate=0.01)]),
        bone("scout_zipper", "accessory_2", [0, 17.9, -2.35], [cube([-0.15, 13.4, -2.62], [0.3, 9.1, 0.2], box_faces(128, 256, 1, 9, 1), inflate=0.01)]),
        bone("scout_left_pocket", "accessory_2", [2.0, 15.9, -2.15], [cube([0.7, 14.2, -2.38], [2.1, 2.3, 0.3], box_faces(128, 256, 2, 2, 1), inflate=0.01)]),
        bone("scout_right_pocket", "accessory_2", [-2.0, 15.9, -2.15], [cube([-2.8, 14.2, -2.38], [2.1, 2.3, 0.3], box_faces(128, 256, 2, 2, 1), inflate=0.01)]),
        bone("scout_watch", "left_arm_lower", [3.9, 12.0, -1.6], [cube([3.5, 11.4, -2.1], [1.3, 1.1, 0.4], box_faces(384, 384, 1, 1, 1), inflate=0.01)]),
        bone("scout_jacket_tail", "accessory_2", [0, 13.0, 2.0], [cube([-4.1, 10.8, 1.8], [8.2, 2.5, 0.4], box_faces(128, 256, 8, 4, 1), inflate=0.01)]),
        bone("scout_collar_left", "accessory_2", [2.5, 21.5, -2.1], [cube([0.5, 19.8, -2.4], [3.0, 2.6, 0.4], box_faces(128, 256, 4, 3, 1), inflate=0.01)]),
        bone("scout_collar_right", "accessory_2", [-2.5, 21.5, -2.1], [cube([-3.5, 19.8, -2.4], [3.0, 2.6, 0.4], box_faces(128, 256, 4, 3, 1), inflate=0.01)]),
        *sleeve_layers(spec),
    ]
...
def main() -> None:
    ...
    print("Generated four 3D GeckoLib models with HD skin UV mapping and realistic 3D hair/eye bones.")
